...
int g_auxWindow_w = 640;
int g_auxWindow_h = 400;
...
void InitializeBar()
{
    ...
    TwAddVarRW(g_pTweakbar, "Draw HydraScene", TW_TYPE_BOOLCPP, &g_app.m_hydraScene.m_bDraw,
               "  group='HydraScene' ");
    TwAddVarRW(g_pTweakbar, "Hydra Location x", TW_TYPE_FLOAT, &g_app.m_hydraScene.m_baseOffset.x,
               " min=-10 max=10 step=0.05 group='HydraScene' ");
    TwAddVarRW(g_pTweakbar, "Hydra Location y", TW_TYPE_FLOAT, &g_app.m_hydraScene.m_baseOffset.y,
               " min=-10 max=10 step=0.05 group='HydraScene' ");
    TwAddVarRW(g_pTweakbar, "Hydra Location z", TW_TYPE_FLOAT, &g_app.m_hydraScene.m_baseOffset.z,
               " min=-10 max=10 step=0.05 group='HydraScene' ");
...
void PollEvents()
{
    ...
    while (SDL_PollEvent(&event))
    {
        ...
        case SDL_MOUSEWHEEL:
            g_app.mouseWheel(event.wheel.x, event.wheel.y);
            break;
